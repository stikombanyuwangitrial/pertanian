      ...
      <div className="overflow-hidden border border-white w-full max-h-screen lg:h-full rounded-lg">
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="flex-1 relative overflow-hidden justify-center w-full h-full items-center">
            ...
            />
            <div className="text-white mx-2 px-2 text-justify h-full overflow-y-auto no-scrollbar overflow-hidden absolute bg-black bg-opacity-50 top-0 left-1/2 transform -translate-x-1/2 rounded-b-lg max-lg:rounded-r-none w-full h-full px-2 text-xs lg:max-h-screen">
